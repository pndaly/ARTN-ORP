...
# -
FORMAT_HRULE = f'-'*260
def print_data(_header='', _data=None):
...
# default(s)
# -
DEFAULT_ISO = get_date_time().split('T')[0].replace('-', '').strip()
