...
def vatt_observe(_obsreq=None, _user=None, _sim=False):
    ...
    if _sim:
        tel_log(f'vatt_observe> entry _obsreq={_obsreq.__repr__()}, _user={_user.__repr__()}, _sim={str(_sim)}', True, False)
    else:
        tel_logger.info(f'vatt_observe> entry _obsreq={_obsreq.__repr__()}, _user={_user.__repr__()}, _sim={str(_sim)}')
    ...
    if _sim:
        ...
        tel_log(f'vatt_observe> exit _obsreq={_obsreq.__repr__()}, _user={_user.__repr__()}, _sim={str(_sim)}', True, False)
        ...
        tel_logger.info(f'vatt_observe> exit _obsreq={_obsreq.__repr__()}, _user={_user.__repr__()}, _sim={str(_sim)}')
        return _json, _id
